...
// import { moviePage } from "../../redux/actions";

// const mykey = process.env.REACT_APP_USER_API_KEY;
// const Movies = () => {
//   const responseInfo = useGetAllMoviesQuery();
...
//         setNumOfPages(responseInfo?.data?.total_pages >= 500 ? 500 : responseInfo?.data?.total_pages);
//         setLoading(false);
//   }, [page, genreStr,language]);
...
//         </Container>
//         {numOfPages > 1 && (
//           <MyPagination setPage={page} numOfPages={numOfPages} />
//         )}
//           {(!data?.length && loading === false) ? <h1 className="no-data-heading"> <i className="fa-solid fa-face-frown"></i> No Data Found</h1> : ""}
//       </div>
//       <Footer />
